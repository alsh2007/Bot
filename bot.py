...
COOKIES = os.getenv("COOKIES")  # الكوكيز تخليها كـ سطر واحد في متغير ENV
...
def download_audio(url):
    ...
    ydl_opts = {
        ...
        "noplaylist": False,
        "quiet": True,
        "cookiefile": COOKIES if COOKIES else None,  # يستخدم متغير ENV للكوكيز
    }
...
async def start(update: Update, context: CallbackContext):
    await update.message.reply_text(
        "Welcome! Send me a YouTube video or playlist link to get audio files."
    )
